...
{\centering{
		\framebox[\linewidth]{
	\textbf{What is the effect of an undetected outlier in a railway remote monitoring system?}
} }}\par
\vspace{1.5em}
...
{\centering{
		\framebox[\linewidth]{
			\textbf{How to effectively detect an outlier in a railway remote monitoring system?}
} }}\par
\vspace{1.5em}
