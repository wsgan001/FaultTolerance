...
\begin{description}
	...
	Is based on the assumption that a given measurement may be rejected, if the probability of having the deviation for this average value is lower than the inverse of the double of the number of measurements. 
